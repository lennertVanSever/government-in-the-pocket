...
const facebookPageToken = (process.env.facebookPageToken || "EAAFuNlbZBRq0BAC3RXiSSaJAcnvuIrSgHRvedzBj4eDQ3jSnWK13dZBx4ydyZAdNhwTbF2HFfoAEd5U6D0cT8QMs6YEpAndb873xxopZAZCMfijDJ2rekdeZBzPSahZBIR1L6wTDZAcbrAM3btAHsEHcX3jYPqSSZBNZAQZAdGI9Vg0yQZDZD");
...
function saveLanguage(sender, language){
  ...
  citizens.update({facebook_id: sender}, {$set: {"language": language}});
}
...
module.exports = function (app) {
  ...
  app.post('/bot/login', function (req, res) {
    ...
    let messageData = {
      "attachment":{
        ...
        "payload":{
          "template_type":"button",
          "text":"Je bent succesvol ingelogd, wat wil je nu doen?",
          "buttons":[
            {
              "type": "postback",
